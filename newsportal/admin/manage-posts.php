                                    ...
                                    <div class="table-responsive">
                                        <table id="table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $query = mysqli_query($con, "SELECT tblposts.id as postid,tblposts.PostTitle as title,tblposts.carousel as car,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.Is_Active=1 ");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($row['car']) ?>
                                                    </td>
