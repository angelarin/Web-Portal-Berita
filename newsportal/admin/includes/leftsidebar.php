...
<?php if($_SESSION['utype']=='1'):?>
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Accounts </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-subadmins.php">Add Account</a></li>
                                    <li><a href="manage-subadmins.php">Manage Account</a></li>
                                </ul>
                            </li>
<?php endif;?>
  ...
  <li class="has_sub">
   ...
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> geryman21@gmail.com</p>
                    </div>
