...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "UPDATE tblposts set PostTitle='$posttitle',carousel='$car',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status',lastUpdatedBy='$lastuptdby' where id='$postid'");
        if ($query) {
            $msg = "Post updated ";
        } else {
                                    ...
                                    <div class="p-6">
                                        <div class="">
                                            <form name="addpost" method="post">
                                                ...
                                                <div class="form-group m-b-20">
                                                    <label for="exampleInputEmail1">Select Carousel</label><br>
                                                    <input type="radio" id="car" name="car" value="1" <?php if (isset($_POST['car']) && $_POST['car'] == 1) : ?>checked='checked' <?php endif; ?> required>
                                                    <label for="1">Carousel 1</label><br>
                                                    <input type="radio" id="car" name="car" value="2" <?php if (isset($_POST['car']) && $_POST['car'] == 2) : ?>checked='checked' <?php endif; ?> required>
                                                    <label for="1">Carousel 1</label><br>
                                                    <input type="radio" id="car" name="car" value="3" <?php if (isset($_POST['car']) && $_POST['car'] == 3) : ?>checked='checked' <?php endif; ?> required>
                                                    <label for="3">Carousel 3</label><br>
                                                    <input type="radio" id="car" name="car" value="0" <?php if (isset($_POST['car']) && $_POST['car'] == 0) : ?>checked='checked' <?php endif; ?> required>
                                                    <label for="0">No Carousel</label><br>
                                                </div>
