      ...
      <div class="card-body">
        <form name="search" action="search.php" method="post">
          <div class="input-group">
            ...
            <input style="border-radius: 20px;" type="text" name="searchtitle" class="form-control" placeholder="Search for..." required>
    ...
    <div class="card-body">
      <ul class="mb-0">
        ...
        ?>
          ...
          <li>
            <a href="news-details-guest.php?nid=<?php echo htmlentities($row['pid']) ?>"><?php echo htmlentities($row['posttitle']); ?></a>
          </li>
        <?php } ?>
      </ul>
    </div>
    ...
    <div class="card-body">
      <ul>
        ...
        ?>
          ...
          <li>
            <a href="news-details-guest.php?nid=<?php echo htmlentities($result['pid']) ?>"><?php echo htmlentities($result['posttitle']); ?></a>
          </li>
        <?php } ?>
      </ul>
    </div>
