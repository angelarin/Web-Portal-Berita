    ...
    <div id="wrapper">
        <div class="topbar">
            <div class="topbar-left">
                <a href="../index.php" class="logo"><span>E-Zone<span>Guest</span></span><i class="mdi mdi-layers"></i></a>
            </div>
            <?php include('includesguest/topheader.php'); ?>
        </div>
        <?php include('includesguest/leftsidebar.php'); ?>
                        ...
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb p-0 m-0">
                                    ...
                                    <li>
                                        <a href="../index-guest.php">Guest</a>
                                    </li>
                                    <li class="active">
                                        Profile
                                    </li>
